<template>
  <!-- -navbar -->
  <nav class="bg-whiteF border-b shadow w-full fixed border-gray-500 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div class="flex items-center md:order-2">
        <button
          ...
          <img
            ...
            src="https://source.boringavatars.com/beam/256/${account.value}?colors=ffabab,ffdaab,ddffab,abe4ff,d9abff"
            alt="Rounded avatar" />
        </button>
        <!-- Dropdown menu -->
      ...
      <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
        <ul
          ...
          <li class="px-3" :class="{ 'border-b-2 border-blueB text-blueB': route.path === '/rental' || '/rentalinfo' }">
            <div
            ...
            <div id="dropdownHover" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
              <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownHoverButton">
                ...
                <li>
                  <a href="/rentalinfo" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">場地租借</a>
                </li>
              </ul>
            </div>
          </li>
...
const { isLogin, isAdmin, account, email } = storeToRefs(user)
const { logout } = user
